...
urlpatterns = [
    ...
    path('business/create-comment/', views.create_comment, name='create_comment'),
    path('business/edit-comment/', views.edit_comment, name='edit_comment'),
    path('business/detail-comment/<int:business_id>', views.detail_comment, name='detail_comment'),
    path('business/create-promo/', views.create_promo, name='create_promo'),
